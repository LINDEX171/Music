...
class FeatPage extends StatefulWidget {
  ...
  @override
  State<FeatPage> createState() => _HomePageState();
}

class _HomePageState extends State<FeatPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title:  Text("Featuring",  style: TextStyle(
      ...
      body: Consumer<PlaylistProvider>(
        builder: (context, value, child) {
          ...
          String albumName = songsByAlbum.keys.elementAt(5); // Accède au deuxième album dans la liste des clés.
