...
class DqPage extends StatefulWidget {
  const DqPage({super.key});

  @override
  State<DqPage> createState() => _HomePageState();
}

class _HomePageState extends State<DqPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title:  Text("Dip Quinzaine",  style: TextStyle(
      ...
      body: Consumer<PlaylistProvider>(
        builder: (context, value, child) {
          ...
          String albumName = songsByAlbum.keys.elementAt(4); // Accède au deuxième album dans la liste des clés.
