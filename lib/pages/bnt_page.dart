...
class BntPage extends StatefulWidget {
  const BntPage({super.key});

  @override
  State<BntPage> createState() => _HomePageState();
}

class _HomePageState extends State<BntPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title:  Text("Beuss Niki Tay",  style: TextStyle(
      ...
      body: Consumer<PlaylistProvider>(
        builder: (context, value, child) {
          ...
          String albumName = songsByAlbum.keys.elementAt(3); // Accède au deuxième album dans la liste des clés.
